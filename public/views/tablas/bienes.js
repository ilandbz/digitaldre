new Vue({
    ...
    methods: {
        ...
        Buscar(page) {
            ...
            urlBuscar = 'bienes/buscar?page=' + page;
            axios.post(urlBuscar, {
                filter: this.search.filter,
                search: this.search.datos,
            }).then(response => {
                this.Load('my_table', 'off', null);
                this.listRequest = response.data.bienes.data;
                this.to_pagination = response.data.bienes.to;
        ...
        Modal(size, metodo, id, seleccion) {
            ...
            switch (metodo) {
                ...
                case 'edit':
                    this.bien.grupo = seleccion.grupo_id;
                    this.bien.clase = seleccion.clase_id;
                    this.bien.nombre = seleccion.x_nombre;
                    this.bien.codigo = seleccion.c_codigo;
                    this.bien.resolucion = seleccion.x_resolucion;
                    break;

                case 'delete':
                    this.bien.nombre = seleccion.c_codigo+': '+seleccion.x_nombre;
                    break;
        ...
        Store(form) {
            ...
            this.errors = [];
            axios.post('bienes/store', {
                grupo: this.bien.grupo,
