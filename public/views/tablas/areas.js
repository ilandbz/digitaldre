new Vue({
    ...
    methods: {
        ...
        Buscar(page) {
            ...
            urlBuscar = 'areas/buscar?page=' + page;
            axios.post(urlBuscar, {
                filter: this.search.filter,
                search: this.search.datos,
            }).then(response => {
                this.Load('my_table', 'off', null);
                this.listRequest = response.data.areas.data;
                this.to_pagination = response.data.areas.to;
        ...
        Modal(size, metodo, id, seleccion) {
            ...
            switch (metodo) {
                ...
                case 'edit':
                    this.area.direccion = seleccion.direccion_id;
                    this.area.nombre = seleccion.x_areas;                 
                    break;
        ...
        Store(form) {
            ...
            this.errors = [];
            axios.post('areas/store', {
                direccion: this.area.direccion,
        ...
        SelecDireccion(value) {
            this.area.direccion_id = value.id;
            this.area.direccion_text = value.x_direcciones;
        },
