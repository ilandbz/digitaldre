new Vue({
    ...
    data: {
        ...
        search: {
            'filter': 1,
            'text_filter': 'Buscar por unidades',
            'datos': null
        },
        send: '',
        page: 1,
    ...
    methods: {
        ...
        Buscar(page) {
            ...
            urlBuscar = 'unidades/buscar?page=' + page;
            axios.post(urlBuscar, {
                filter: this.search.filter,
                search: this.search.datos,
            }).then(response => {
                this.Load('my_table', 'off', null);
                this.listRequest = response.data.unidades.data;
                this.to_pagination = response.data.unidades.to;
        ...
        Modal(size, metodo, id, seleccion) {
            ...
            switch (metodo) {                
                ...
                case 'edit':
                    ...
                    this.unidad.nombre = seleccion.x_unidades;
                    break;
