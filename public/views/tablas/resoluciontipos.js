new Vue({
    ...
    methods: {
        ...
        Buscar(page) {
            ...
            urlBuscar = 'resoluciontipos/buscar?page=' + page;
            axios.post(urlBuscar, {
                filter: this.search.filter,
                search: this.search.datos,
            }).then(response => {
                this.Load('my_table', 'off', null);
                this.listRequest = response.data.resoluciontipos.data;
                this.to_pagination = response.data.resoluciontipos.to;
        ...
        Modal(size, metodo, id, seleccion) {
            ...
            switch (metodo) {                
                ...
                case 'edit':
                    ...
                    this.resoluciontipo.nombre = seleccion.x_resoluciontipos;
                    break;
        ...
        Update(form) {
            ...
            this.errors = [];
            axios.post('resoluciontipos/update', {
                id: this.id,
                //email: this.asociacion.email,
                //telefono: this.asociacion.telefono,
                //direccion: this.asociacion.direccion,
        ...
        Delete(form) {
            ...
            this.errors = [];
            axios.post('resoluciontipos/delete', {
                id: this.id,
            }).then(response=> {
                this.Load(form, 'off', null);
