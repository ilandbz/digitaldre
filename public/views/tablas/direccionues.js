new Vue({
    ...
    methods: {
        ...
        Buscar(page) {
            ...
            urlBuscar = 'direccionues/buscar?page=' + page;
            axios.post(urlBuscar, {
                filter: this.search.filter,
                search: this.search.datos,
            }).then(response => {
                this.Load('my_table', 'off', null);
                this.listRequest = response.data.direccionues.data;
                this.to_pagination = response.data.direccionues.to;
        ...
        Modal(size, metodo, id, seleccion) {
            ...
            switch (metodo) {                
                ...
                case 'edit':
                    ...
                    this.direccionu.nombre = seleccion.x_direcciones;
                    break;
        ...
        Update(form) {
            ...
            this.errors = [];
            axios.post('direccionues/update', {
                id: this.id,
                //email: this.asociacion.email,
                //telefono: this.asociacion.telefono,
                //direccion: this.asociacion.direccion,
        ...
        Delete(form) {
            ...
            this.errors = [];
            axios.post('direccionues/delete', {
                id: this.id,
            }).then(response=> {
                this.Load(form, 'off', null);
