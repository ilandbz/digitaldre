new Vue({
    ...
    methods: {
        ...
        Buscar(page) {
            ...
            urlBuscar = 'clases/buscar?page=' + page;
            axios.post(urlBuscar, {
                filter: this.search.filter,
                search: this.search.datos,
            }).then(response => {
                this.Load('my_table', 'off', null);
                this.listRequest = response.data.clases.data;
                this.to_pagination = response.data.clases.to;
        ...
        Modal(size, metodo, id, seleccion) {
            ...
            switch (metodo) {                
                ...
                case 'edit':
                    this.clase.nombre = seleccion.x_nombre;
                    this.clase.codigo = seleccion.c_codigo;
                    break;
