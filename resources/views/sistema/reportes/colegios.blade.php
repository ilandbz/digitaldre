                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">UGELES</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title" style="color: #00b1b1;">REPORTE DE COLABORADORES-UGELES</h3>  
                    ...
                    <div class="card-body">
                        <div class="table-responsive" id="my_table" style="min-height: 140px;">
                                ...
                                <table id="colegios" class="table table-md table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$colegio->id}}</td>
                                            <td>{{$colegio->x_persona}}</td>
                                            <td>{{$colegio->c_dni}}</td>
                                            <td>{{$colegio->x_direcciones}}</td>
                                            <td>{{$colegio->x_areas}}</td>
                                            <td>{{$colegio->x_unidades}}</td>
                                            <td>{{$colegio->x_cargos}}</td>
                                            <td>{{$colegio->x_tipopersonal}}</td>
                                            <td>{{$colegio->x_telefono}}</td>
                                            <td>{{$colegio->x_telefono2}}</td>
                                            <td>{{$colegio->x_email}}</td>
                                            <td>{{$colegio->x_email2}}</td>
                                            <td>{{$colegio->x_nombre}}</td>
                                        </tr>
                                        @endforeach
