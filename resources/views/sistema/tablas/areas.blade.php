...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row" style="padding-top: 10px;" id="areas">
                <div class="col-12">
                                            ...
                                            <div class="m-2">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <select id="direccion" v-model="area.direccion" class="form-control" :class="[errors.direccion ? 'border-error' : '']">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input type="text" id="nombre" v-model="area.nombre" class="form-control" :class="[errors.nombre ? 'border-error' : '']">
                                ...
                                <div class="modal-content" v-if="modal.method == 'delete'" id="delete">
                                    <div class="modal-body text-center" style="padding: 0.8rem 1.3rem">
                                        ...
                                        <div class="card card-danger card-outline">
                                            <div class="m-2">
                                                <p class="text-center">¿ Realmente desea eliminar el Area: <br>
                                                    <strong>@{{area.nombre}}</strong> ?</p>
                                ...
                                <table class="table table-md table-hover">
                                    ...
                                    <tbody>
                                        <tr v-for="(data, index) in listRequest" :class="'active-'+data.l_activo">
                                            ...
                                            <td class="text-left"><strong><i class="fas fa-building"></i> </strong> @{{data.get_direccion.x_direcciones}}</td>
...
@section('js')
    ...
    <script src="{{asset('views/tablas/areas.js')}}"></script>
@endsection