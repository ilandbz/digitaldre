...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row" style="padding-top: 10px;" id="modelos">
                <div class="col-12">
                            ...
                            <div class="modal-dialog" role="document" :class="modal.size">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="select-dropdown">
                                                        <button type="button" class="btn-dropdown form-control form-control text-left" data-toggle="dropdown" @click="Autofocus('bien_search')">@{{modelo.bien_text}} <span><i class="fas fa-angle-down"></i></span></button>
                                                        <div class="dropdown-menu dropdown-sm lista-li-select2" id="myDropdown" style="bottom: 0 !important; height: 300px; min-width: 98%;">
                                                            ...
                                                            <a class="dropdown-item" v-for="bien in bienes" @click="SelecBien(bien)" :class="[(modelo.bien_id == bien.id) ? 'active' : '']">@{{bien.c_codigo+': '+bien.x_nombre}}</a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="select-dropdown">
                                                        <button type="button" class="btn-dropdown form-control form-control text-left" data-toggle="dropdown" @click="Autofocus('persona_search')">@{{modelo.persona_text}} <span><i class="fas fa-angle-down"></i></span></button>
                                                        <div class="dropdown-menu dropdown-sm lista-li-select2" id="myDropdownp" style="bottom: 0 !important; height: 300px; min-width: 98%;">
                                                            ...
                                                            <a class="dropdown-item" v-for="persona in personas" @click="SelecPersona(persona)" :class="[(modelo.persona_id == persona.id) ? 'active' : '']">@{{persona.c_dni+': '+persona.x_nombre}}</a>
                                                        </div>
                                                    </div>
                                ...
                                <div class="modal-content" v-if="modal.method == 'delete'" id="delete">
                                    <div class="modal-body text-center" style="padding: 0.8rem 1.3rem">
                                        ...
                                        <div class="m-2">
                                            <p class="text-center">¿ Realmente desea eliminar el Modelo: <br>
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            ...
                                            <div class="dropdown-menu dropdown-sm">
                                                <a class="dropdown-item" href="#" :class="[(search.filter == 1) ? 'active' : '']" @click="Filtrar('Nombre del Modelo', 1)">Nombre</a>
                                ...
                                <table class="table table-md table-hover">
                                    ...
                                    <tbody>
                                        <tr v-for="(data, index) in listRequest" :class="'active-'+data.l_activo">
                                            ...
                                            <td> @{{data.get_persona.x_nombre}}</td>
...
@section('js')
    ...
    <script src="{{asset('views/tablas/modelos.js')}}"></script>
@endsection