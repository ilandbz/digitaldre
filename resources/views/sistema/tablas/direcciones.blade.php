...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row" style="padding-top: 10px;" id="direcciones">
                <div class="col-12">
                                            ...
                                            <div class="m-2">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input type="text" id="nombre" v-model="direccion.nombre" class="form-control" :class="[errors.nombre ? 'border-error' : '']" >
...
@section('js')
    <script src="{{asset('views/tablas/direcciones.js')}}"></script>
@endsection