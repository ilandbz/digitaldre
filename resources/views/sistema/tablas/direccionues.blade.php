...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">DIRECCIONES UGEL</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row" style="padding-top: 10px;" id="direccionues">
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">LISTA DE DIRECCIONES UGEL</h3>
                            ...
                            <div class="modal-dialog" role="document" :class="modal.size">
                                            ...
                                            <div class="m-2">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="nombre">DIRECCION <span class="obligatorio">*</span></label>
                                                        <input type="text" id="nombre" v-model="direccionu.nombre" class="form-control" :class="[errors.nombre ? 'border-error' : '']" >
                                        ...
                                        <div class="card card-warning card-outline">
                                            <div class="m-2">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="nombre">DIRECCIÓN <span class="obligatorio">*</span></label>
                                                        <input type="text" id="nombre" v-model="direccionu.nombre" class="form-control" :class="[errors.nombre ? 'border-error' : '']" >
                                                        <div class="input-error" v-if="errors.nombre">@{{ errors.nombre[0] }}</div>
                                                    </div>
                                ...
                                <div class="modal-content" v-if="modal.method == 'delete'" id="delete">
                                    <div class="modal-body text-center" style="padding: 0.8rem 1.3rem">
                                        <button type="button" class="btn-close" data-dismiss="modal" @click="CloseModal"><i class="fas fa-times"></i></button>
                                        <div class="text-center mb-4 mt-4">
                                            <h3>ELIMINAR DIRECCION UGEL</h3>
                                        </div>
                                        <div class="card card-danger card-outline">
                                            <div class="m-2">
                                                <p class="text-center">¿ Realmente desea eliminar la Dirección: <br>
                                                    <strong>@{{direccionu.nombre}}</strong> ?</p>
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            ...
                                            <div class="dropdown-menu dropdown-sm">
                                                <a class="dropdown-item" href="#" :class="[(search.filter == 1) ? 'active' : '']" @click="Filtrar('Buscar por Direccion', 1)">Direccion</a>
                                            </div>
                                        </div>
                                ...
                                <table class="table table-md table-hover">
                                    <thead>
                                        <tr style="background-color: #f2f2f2;">
                                            ...
                                            <th width="80%" class="text-left">DIRECCION</th>
                                    ...
                                    <tbody>
                                        <tr v-for="(data, index) in listRequest" :class="'active-'+data.l_activo">
                                            ...
                                            <td class="text-left"><strong><i class="fas fa-building"></i> </strong> @{{data.x_direcciones}}</td>
...
@section('js')
    <script src="{{asset('views/tablas/direccionues.js')}}"></script>
@endsection