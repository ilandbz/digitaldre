...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row" style="padding-top: 10px;" id="ugeles">
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">REGISTRO GENERAL DE COLABORADORES POR UGELES</h3>
                                          ...
                                          <div class="m-2">
                                            <div class="form-row">
                                                ...
                                                <!-- <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" id="nombre" v-model="ugel.nombre" class="form-control" :class="[errors.nombre ? 'border-error' : '']">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="select-dropdown">
                                                        <button type="button" class="btn-dropdown form-control form-control text-left" data-toggle="dropdown" @click="Autofocus('persona_search')">@{{ugel.persona_text}} <span><i class="fas fa-angle-down"></i></span></button>
                                                        <div class="dropdown-menu dropdown-sm lista-li-select2" id="myDropdownp" style="bottom: 0 !important; height: 300px; min-width: 98%;">
                                                            ...
                                                            <a class="dropdown-item" v-for="persona in personas" @click="SelecPersona(persona)" :class="[(ugel.persona_id == persona.id) ? 'active' : '']">@{{persona.c_dni+': '+persona.x_nombre}}</a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-auto form-group col-md-6">
                                                    <label  for="tipopersonal">TIPO PERSONAL <span class="obligatorio">*</span></label>
                                                        <select  id="tipopersonal" v-model="ugel.tipopersonal" class="form-control" :class="[errors.tipopersonal ? 'border-error' : '']">
                                                ...
                                                <!--<div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" id="dni" v-model="ugel.dni" class="form-control" :class="[errors.dni ? 'border-error' : '']" maxlength="8" onkeypress="Numero()" autocomplete="off">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" id="telefono" v-model="ugel.telefono" class="form-control" :class="[errors.telefono ? 'border-error' : '']" maxlength="9" onkeypress="Numero()">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="unidad" v-model="ugel.unidad" class="form-control" :class="[errors.unidad ? 'border-error' : '']">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="direccionu">DIRECCION UGEL<span class="obligatorio">*</span></label>
                                                    <select id="direccionu" v-model="ugel.direccionu" class="form-control" :class="[errors.direccionu ? 'border-error' : '']" @change="buscarareau">
                                                        <option value="">--- Seleccione Opción ---</option>
                                                        @foreach ($direccionues as $direccionu)
                                                            <option value="{{$direccionu->id}}">{{$direccionu->id.': '.$direccionu->x_direcciones}}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="input-error" v-if="errors.direccionu">@{{ errors.direccionu[0] }}</div>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="areau">AREA UGEL <span class="obligatorio">*</span></label>
                                                    <select id="areau" v-model="ugel.areau" class="form-control" :class="[errors.areau ? 'border-error' : '']">
                                                        <option value="">--- Seleccione Opción ---</option>
                                                        <option v-for="areau in areasu" :value="areau.id">@{{areau.id+': '+areau.x_areas}}</option>
                                                    </select>
                                                    <div class="input-error" v-if="errors.areau">@{{ errors.areau[0] }}</div>
                                                </div>
                                                
                                                
                                                <div class="form-group col-md-12">
                                                    <label for="cargo">CARGO FUNCIONAL <span class="obligatorio">*</span></label>
                                                    <select id="cargo" v-model="ugel.cargo" class="form-control" :class="[errors.cargo ? 'border-error' : '']">
                                                        <option value="">--- Seleccione Opción ---</option>
                                                ...
                                                <!--<div class="col-auto form-group col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="email" id="email" v-model="ugel.email" class="form-control" :class="[errors.email ? 'border-error' : '']">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" id="telefono2" v-model="ugel.telefono2" class="form-control" :class="[errors.telefono2 ? 'border-error' : '']" maxlength="9" onkeypress="Numero()">
                                                ...
                                                <div class="col-auto form-group col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group-text">@</div>
                                                        <input type="email2" id="email2" v-model="ugel.email2" class="form-control" :class="[errors.email2 ? 'border-error' : '']">
                                ...
                                <table class="table table-lg table-hover">
                                    ...
                                    <tbody>
                                        <tr v-for="(data, index) in listRequest" :class="'active-'+data.l_activo">
                                            ...
                                            <!--<td class="text-left">@{{data.x_nombres}}</td>
                                            <td class="text-center">@{{data.c_dni}}</td>-->
                                            <td class="text-left">@{{data.get_direccionu.x_direcciones}}</td>
                                            <td class="text-left">@{{data.get_areau.x_areas}}</td>
...
<script>
    ...
    var my_areasu = {!! json_encode($areasu) !!};
    var my_personas = {!! json_encode($personas) !!};
</script>
    <script src="{{asset('views/tablas/ugeles.js')}}"></script>
@endsection
