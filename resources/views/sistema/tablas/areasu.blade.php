...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">AREAS - UGEL</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row" style="padding-top: 10px;" id="areasu">
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">LISTA DE AREAS - UGELES</h3>
                                            ...
                                            <div class="m-2">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <select id="direccion" v-model="areau.direccion" class="form-control" :class="[errors.direccion ? 'border-error' : '']">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="nombre">NOMBRE DEL AREA / ESPECIALISTA<span class="obligatorio">*</span></label>
                                                        <input type="text" id="nombre" v-model="areau.nombre" class="form-control" :class="[errors.nombre ? 'border-error' : '']">
                                ...
                                <div class="modal-content" v-if="modal.method == 'delete'" id="delete">
                                    <div class="modal-body text-center" style="padding: 0.8rem 1.3rem">
                                        ...
                                        <div class="card card-danger card-outline">
                                            <div class="m-2">
                                                <p class="text-center">¿ Realmente desea eliminar el Area de la Ugel: <br>
                                                    <strong>@{{areau.nombre}}</strong> ?</p>
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            ...
                                            <div class="dropdown-menu dropdown-sm">
                                                <a class="dropdown-item" href="#" :class="[(search.filter == 1) ? 'active' : '']" @click="Filtrar('Datos del Area', 1)">Area</a>
                                                <a class="dropdown-item" href="#" :class="[(search.filter == 2) ? 'active' : '']" @click="Filtrar('Tipo de Direccion', 2)">Direccion</a>
                                            </div>
                                        </div>
                                        ...
                                        <select v-model="search.datos" class="form-control" :placeholder="search.text_filter" @change="Buscar" v-else>
                                            <option value="">--- Todas los Direcciones ---</option>
                                            @foreach ($direcciones as $direccion)
                                                <option value="{{$direccion->id}}">{{$direccion->x_direcciones}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <table class="table table-md table-hover">
                                    <thead>
                                        <tr style="background-color: #f2f2f2;">
                                            ...
                                            <th width="25%" class="text-left">DIRECCION</th>
                                            <th width="60%">NOMBRE DEL AREA</th>
                                    ...
                                    <tbody>
                                        <tr v-for="(data, index) in listRequest" :class="'active-'+data.l_activo">
                                            ...
                                            <td class="text-left"><strong><i class="fas fa-building"></i> </strong> @{{data.get_direccionu.x_direcciones}}</td>
                                            <td><strong><i class="far fa-building"></i> </strong> @{{data.x_areas}}</td>
...
@section('js')
    <script>
        var my_direcciones = {!! json_encode($direcciones) !!};
    </script>
    <script src="{{asset('views/tablas/areasu.js')}}"></script>
@endsection