...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row" style="padding-top: 10px;" id="clases">
                <div class="col-12">
                    <div class="card card-danger card-outline">
                        <div class="card-header">
                            <h3 class="card-title">LISTA DE CLASE GENÉRICO</h3>
                            ...
                            <div class="modal-dialog" role="document" :class="modal.size">
                                        ...
                                        <div class="m-2">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" id="codigo" v-model="clase.codigo" class="form-control" :class="[errors.codigo ? 'border-error' : '']" maxlength="2" onkeypress="Numero()" autocomplete="off">
                                                    <div class="input-error" v-if="errors.codigo">@{{ errors.codigo[0] }}</div>
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label for="nombre">NOMBRE DE CLASE GENÉRICO <span class="obligatorio">*</span></label>
                                                    <input type="text" id="nombre" v-model="clase.nombre" class="form-control" :class="[errors.nombre ? 'border-error' : '']">
                                ...
                                <div class="modal-content" v-if="modal.method == 'delete'" id="delete">
                                    <div class="modal-body text-center" style="padding: 0.8rem 1.3rem">
                                        ...
                                        <div class="m-2">
                                            <p class="text-center">¿ Realmente desea eliminar la Clase: <br>
                                ...
                                <table class="table table-md table-hover">
                                    <thead>
                                        <tr style="background-color: #f2f2f2;">
                                            ...
                                            <th width="70%">NOMBRE DE LA CLASE</th>
...
@section('js')
    <script src="{{asset('views/tablas/clases.js')}}"></script>
@endsection