...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row" style="padding-top: 10px;" id="unidades">
                <div class="col-12">
                                            ...
                                            <div class="m-2">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="nombre">UNIDAD <span class="obligatorio">*</span></label>
                                                        <input type="text" id="nombre" v-model="unidad.nombre" class="form-control" :class="[errors.nombre ? 'border-error' : '']" >
                                ...
                                <div class="modal-content" v-if="modal.method == 'delete'" id="delete">
                                    <div class="modal-body text-center" style="padding: 0.8rem 1.3rem">
                                        ...
                                        <div class="card card-danger card-outline">
                                            <div class="m-2">
                                                <p class="text-center">¿ Realmente desea eliminar la Unidad: <br>
                                                    <strong>@{{unidad.nombre}}</strong> ?</p>
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            ...
                                            <div class="dropdown-menu dropdown-sm">
                                                <a class="dropdown-item" href="#" :class="[(search.filter == 1) ? 'active' : '']" @click="Filtrar('Buscar por Unidad', 1)">Unidad</a>
                                            </div>
                                        </div>
                                ...
                                <table class="table table-md table-hover">
                                    <thead>
                                        <tr style="background-color: #f2f2f2;">
                                            ...
                                            <th width="80%" class="text-left">UNIDAD</th>
                                    ...
                                    <tbody>
                                        <tr v-for="(data, index) in listRequest" :class="'active-'+data.l_activo">
                                            ...
                                            <td class="text-left"><strong><i class="far fa-building"></i> </strong> @{{data.x_unidades}}</td>
...
@section('js')
    <script src="{{asset('views/tablas/unidades.js')}}"></script>
@endsection