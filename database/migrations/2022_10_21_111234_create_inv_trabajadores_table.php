...
class CreateInvTrabajadoresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inv_trabajadores', function (Blueprint $table) {
            $table->id();
           ...
           // $table->string('x_telefono', 20)->nullable();
            ...
            $table->foreignId('direccion_id')->references('id')->on('inv_direcciones')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('inv_trabajadores');
    }
}
